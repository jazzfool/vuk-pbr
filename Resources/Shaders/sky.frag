...
vec3 atmosphere(vec3 r, vec3 r0, vec3 sun_pos, float sun_intensity, float planet_radius, float atmosphere_radius, vec3 rayleigh_coeff, float mie_coeff, float rayleigh_height, float mie_height, float g) {
